...
// Ensemble permettant au menu de disparaitre automatiquement au clic d'un autre endroit de la page.
    ...
    const ContainerElement = document.getElementById('Container-Menu');

    document.addEventListener('click', function(event) {
    let isClickInside = ContainerElement.contains(event.target);
...
$(document).ready(function() {  
    ...
    // Début du formulaire et de sa vérification 
        ...
        // Déclaration des regex à vérifier 
            ...
            const VerifNom = /^([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1,15})[-\'\s]{0,1}([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1,15})[-\s]{0,1}([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1,15})$/;
            const VerifPrenom = /^([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1,15})[-\'\s]{0,1}([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{0,15})[-\s]{0,1}([A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{0,15})$/;
            const VerifEmail = /^([a-zA-Z0-9-_]{1,20})+(\.[a-zA-Z0-9-_]{1,20})*\@[a-zA-Z0-9_]+(\.[a-zA-Z0-9_]{1,20})*\.[a-zA-Z]{2,4}$/;
            const VerifMessage = /^([A-Za-z0-9._%+&é"'(-è_çà)=-\s][^<>]{1,1000})$/;
        ...
        // Déclaration des flags de vérification
            ...
            let FlagEmail = 0;
            let FlagMessage = 0;
            let Erreur = ["", "", "", ""]; // Tableau qui permettra d'afficher d'où vient l'erreur.
        ...
        // Test + envoie du formulaire
            ...
            btnSubmit.click(function(){
                let TestOK = FlagNom + FlagPrenom + FlagEmail + FlagMessage;
                checkfield();
                if (TestOK == 4)
                {
